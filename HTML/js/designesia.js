 /* --------------------------------------------------
  * © Copyright 2021 - Linea by Designesia
  * --------------------------------------------------*/
(function($) {
	'use strict';
     ...
     var de_nav_color_scroll = 1; // 1 - dark, - 2 light
     ...
     jQuery(document).ready(function() {
         ...
         jQuery("#homepage nav a, .scroll-to").on("click", function(evn) {
             if (this.href.indexOf('#') == 0) { // new added
                 evn.preventDefault();
                 jQuery('html,body').scrollTo(this.hash, this.hash);
             }
         });
		...
		link.on('click', function(e) {
			...
			$(this).parent().find('a').addClass("NoneActive");
			$(this).parent().find('a').removeClass("Active");
			
			$(this).removeClass("NoneActive");
			$(this).addClass("Active");

			$(a).slideDown('fast');

			//$(a).slideToggle('fast');
			$(this).parent().parent().find(".accordion div").not(a).slideUp('fast');
		...
		$(".revealOnScroll.animated").each(function (index) {
         ...
         jQuery(window).on("scroll", function() {
             ...
             /* go to anchor */
             jQuery('#mainmenu.scrollnav li a').each(function() {
                 var cur = jQuery(this);
                 if (this.href.indexOf('#') != -1) {
